 ...
 * License.
 */
package com.aqnote.shared.encrypt.cert.jdk.main;
...
public class AQRootCaMain {
    ...
    public static void main(String[] args) throws CertException, IOException {
        ...
        KeyStore keyStore = CertGenerator.getIns().createRootCert(PASSWD);
        AQCertDo tdPureCertDo = JDKCertSystem.createTDPureCertDo(CertGenerator.CA_ALIAS, keyStore, PASSWD);
