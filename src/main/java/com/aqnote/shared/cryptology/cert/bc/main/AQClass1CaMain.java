...
/**
 * 类AQClass1CaMain.java的实现描述：ca构造器
 * 
...
public class AQClass1CaMain extends AQMain {
    ...
    protected static void updateChain() throws Exception {
        ...
        oStream.close();
        System.out.println("AQNote Class1 CA Update End....");
    }

    // 从META-INF中读取，创建一个中级Class1 CA
    protected static void createChainFromJar() throws Exception {
        ...
        System.out.println("AQNote Class1 cCAa Generate End....");
    }

    // 从输出目录中读取，创建一个中级Class1 CA
    protected static void createChainFromPath(String cafilepath) throws Exception {
        ...
        System.out.println("AQNote server ca created end....");
    }
}
