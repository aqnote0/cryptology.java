...
public class CreateCertFromFile {
    ...
    public static void main(String[] args) throws IOException, CertificateException {
        ...
        String certString = "MIIFeTCCBGGgAwIBAgIBATANBgkqhkiG9w0BAQUFADCBxjELMAkGA1UEBhMCTk8"
        ...
        create(write(certString));
    }

    public static File write(String certStr) throws IOException {

        byte[] ciphertext1 = Base64.getDecoder().decode(certStr);
        File f1 = new File("/Users/aqnote/logs/certificate/case1/case1.csr");
